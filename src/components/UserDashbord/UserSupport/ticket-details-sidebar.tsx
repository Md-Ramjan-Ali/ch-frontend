    ...
    <div className="bg-white rounded-lg shadow-lg p-6 dark:bg-gray-800">
      ...
      <div className="space-y-3 text-sm text-gray-700">
        <div className="flex justify-between items-center">
          ...
          <CategoryTag category={ticket.status || data?.data?.status} />
        </div>
        <div className="flex justify-between items-center">
          <span className="text-gray-500 dark:text-gray-400">Priority</span>
          <PriorityTag priority={ticket.priority|| data?.data?.priority} />
        </div>
        ...
        <p className="flex justify-between items-center">
          ...
          <span className="font-medium dark:text-gray-200">{ticket.created || data?.data?.createdAt.slice(0, 10)}</span>
        </p>
        <p className="flex justify-between items-center">
          <span className="text-gray-500 dark:text-gray-400">Last Update</span>
          <span className="font-medium dark:text-gray-200">{ticket.lastUpdateTime || data?.data?.updatedAt.slice(0, 10)}</span>
        </p>
        {/* <p className="flex justify-between items-center">
